...
* [*Composite Design Pattern*](https://www.scaler.com/topics/composite-design-pattern/), (Applies the common methods to a collection of objects where a partial or complete hierarchy can be established).
